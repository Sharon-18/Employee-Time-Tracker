...
@WebServlet("/WeeklyTasksServlet")
public class WeeklyTasksServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            List<String> labels = taskDAO.getWeeklyLabels(userId);
            List<Double> data = taskDAO.getWeeklyData(userId);
